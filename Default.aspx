          ...
          <td>
                 ...
                 <asp:Label ID="Label14" runat="server" Text="RTO City"  style="color:Blue;font-size:20px"></asp:Label>
                    ...
                    <td>
                                                                 ...
                                                                 <asp:DropDownList ID="DropDownList1" runat="server" style="border-radius:10px" Font-Bold="True">                                                              
                 ...
                 <tr>
                         <td>
                                     <asp:Label ID="Label13" runat="server" Text="qualification :" style="color:Blue;font-size:20px"></asp:Label>
                        </td> 
                         <td>
                 ...
                 <tr>
                  ...
                  <asp:Button ID="Button1" runat="server" Text="Apply Learning" 
             ...
             <div class="msg">
                        <asp:Label ID="Label15" runat="server" Text="" style="color:Maroon;font-size:40px"></asp:Label>   
             </div>
     </div>
    </form>
