...
<body>
	...
	<div class="slider-area">
     ...
     <div class="reg">
        <h1 style="font-size:50px;background-color:orange">Vehicle Registration Search</h1>
        <br><br>
            <table>
                   <tr>
                        <td>
                                
                             <asp:Label ID="Label4" runat="server" Text="Reg. No :" style="color:Blue;font-size:20px"></asp:Label>
                        </td>
                        <td>
                ...
                <tr>
                 ...
                 <td></td>
                 <td>
                             <asp:Button ID="Button1" runat="server" Text="Registraion" 
