<%@ Page Language="C#" AutoEventWireup="true" CodeFile="learning.aspx.cs" Inherits="learning" %>
...
<body>
	...
	<div class="slider-area">
					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								<h1 class="homepage-three-title">E<span>RTO</span>SERVIECS</h1>
						...
						<div class="slider-content-area">
							<div class="slide-text">
								...
								<div class="slider-content-btn">
									...
									<a class="button btn btn-light btn-radius btn-brd" href="E:\project web 2019\contact.aspxcontact.aspx">Contact</a>
								</div>
							</div>
						</div>
					</div>
     ...
     <div class="reg">
        <h1 style="font-size:50px;background-color:orange">Learning  Licence</h1>
            <table align="center">
                <tr>
                    <td>
                ...
                <tr>
                        <td>
                             ...
                             <asp:Label ID="Label13" runat="server" Text="Applicant Name :" style="color:Blue;font-size:20px"></asp:Label>
                        </td>
                        <td>
                ...
                <tr>
                    <td>
                             <asp:Label ID="Label4" runat="server" Text="Father Name" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                                         <asp:Label ID="Label5" runat="server" Text="Date of Birth" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                             <asp:TextBox ID="TextBox3" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                 <tr>
                    <td>
                                         <asp:Label ID="Label6" runat="server" Text="Status" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                                               <asp:Label ID="Label7" runat="server" Text="Address" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                                   <asp:TextBox ID="TextBox4" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                <tr>
                <td>
                                               <asp:Label ID="Label8" runat="server" Text="Mobile No." style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                                   <asp:TextBox ID="TextBox5" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                 <tr>
                <td>
                                               <asp:Label ID="Label9" runat="server" Text="Boold Group" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                                   <asp:TextBox ID="TextBox6" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                 <tr>
                <td>
                                               <asp:Label ID="Label10" runat="server" Text="Pin Code" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                                   <asp:TextBox ID="TextBox7" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>                        
                  ...
                  <tr>
                <td>
                                               <asp:Label ID="Label11" runat="server" Text="Qualification" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                                   <asp:TextBox ID="TextBox8" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                 <tr>
                <td>
                                               <asp:Label ID="Label12" runat="server" Text="Fees Amount" style="color:Blue;font-size:20px"></asp:Label></td>
                    <td>
                                                   <asp:TextBox ID="TextBox9" runat="server" style="border-radius:10px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
        ...
        <div class="container">
            ...
            <div class="owl-services owl-carousel owl-theme">
                ...
                <div class="service-widget">
					...
					<div class="service-dit">
						<h3>Vehicle Registration Search</h3>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">                   
					...
					<p style="font-size:20px;color:Red"><b>Vaibhav</p>
                </div>
