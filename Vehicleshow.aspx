<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vehicleshow.aspx.cs" Inherits="Vehicleshow" %>
...
<body>
	...
	<div class="slider-area">
     ...
     <div class="reg">
        <h1 style="font-size:50px;background-color:orange">Vehicle Registration </h1>
        <br><br>
            <table>
                   <tr>
                        <td>
                                
                             <asp:Label ID="Label4" runat="server" Text="Reg. No :" style="color:Blue;font-size:40px"></asp:Label>
                        </td>
                        <td>
                                      <asp:TextBox ID="TextBox1" runat="server" style="border-radius:10px" 
                                          Enabled="False" Font-Bold="True" Font-Size="40px" ForeColor="Red"></asp:TextBox>
                      </td>
                   </tr>
                   <tr>
                        <td>
                                
                                     <asp:Label ID="Label5" runat="server" Text="Engine No. :" style="color:Blue;font-size:20px"></asp:Label>
                        </td>
                        <td>
                                
                                         <asp:TextBox ID="TextBox3" runat="server" style="border-radius:10px"
                                           Enabled="False" Font-Bold="True" Font-Size="40px" ForeColor="Red"></asp:TextBox>
                        </td>
                ...
                <tr>
                        <td>
                                                 ...
                                                 <asp:Label ID="Label6" runat="server" Text="Chasis No."  style="color:Blue;font-size:20px"></asp:Label>
                        </td>
                        <td>
                        
                                                 <asp:TextBox ID="TextBox5" runat="server" style="border-radius:10px"
                                                   Enabled="False" Font-Bold="True" Font-Size="40px" ForeColor="Red"></asp:TextBox>
                        </td>
                 </tr>
                   <tr>  
                   <td bgcolor="#CC0099">                    
                       <asp:Label ID="Label2" runat="server" Text="Your Registration Success"></asp:Label>
                    </td>
                 </tr>
     ...
     <div class="msg">
                      <asp:Label ID="Label1" runat="server" Text="" style="color:Red;font-size:40px"></asp:Label>
     </div>
