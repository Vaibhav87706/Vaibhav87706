            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <h2><b><font color="dark orange"</font>Welcome to E-RTO System</b></h2>
                        <p class="lead"></p>

                        <p><font  color="orange"size="4"</font><b>The RTO identifies untaxed vehicles, and identify keepers of cars entering various Indian states, or who exceed speed limits on a road that has speed cameras by matching the cars to their keepers utilising the RTO databaseThe High Security Registration plates (HSRP) was introduced to help reduce vehicle crime and improve security. It is intended to deter criminals from disguising stolen cars with the identity of written off or scrapped vehicles.Along with this, the RTO is also responsible to inspect vehicle's insurance and clear the pollution test. </b></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <p class="lead"><font  color="orange"size="4"</font><b>vehicle registration certificate is an official document providing proof of registration of a vehicle. </b></p>

                        <p><font  color="orange"size="4"</font><b>The owner of a vehicle can apply and get duplicate copy of the vehicle registration certificate from the concerned RTO office if it is stolen, lost, destructed and completely written off. A complaint should be lodged to the police station which is situated under the jurisdiction / area of lost before approaching the regional transport officer. After completing the formalities, the owner has to submit FORM 26 and the Police Certificate to the Registering Authority along with the required documents for applying duplicate vehicle registration certificate. </b></p>
